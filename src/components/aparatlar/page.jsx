...
const Aparatlar = () => {
  // Figma dizaynidagi mahsulotlar ma'lumotlar bazasi
  const products = [
    {
      id: 1,
      title: 'T55/50B',
    ...
    },
    {
      ...
      title: 'T35B',
      category: 'ПОЛОМОЕЧНЫЕ МАШИНЫ',
      imageSrc: '/6.jpg', // dizaynda 1, 2, 3-rasmlar bir xil keltirilgan
      buttonText: 'Подробнее',
      link: '/catalog/t35b',
    },
    {
    ...
    },
    {
      ...
      title: 'T45/50B',
      category: 'ПОЛОМОЕЧНЫЕ МАШИНЫ',
      imageSrc: '/7.jpg', // To'rtinchi rasm boshqacha
      price: '100000 UZS',
          ...
          {products.map((product) => (
            <div key={product.id} className="flex flex-col items-start group relative">
              ...
              <div className="relative w-full h-[260px] flex items-center justify-center mb-4 bg-white rounded-lg p-4">
                ...
                {/* Agar Chegirma badgi bo'lsa (4-kartochka uchun) */}
                {product.badge && (
              ...
              {/* Narxlar (Faqat 4-mahsulotda bor) */}
              {product.price && (
              ...
              {/* Tugma (Dizayndagi ko'k rangli kvadrat tugma) */}
              <Link
                href={product.link}
